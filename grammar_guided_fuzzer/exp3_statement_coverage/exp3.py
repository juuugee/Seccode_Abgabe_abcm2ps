...
def run_grammar_guided_statement_coverage_fuzzer(run_time_in_min, dir_path_git, seed_path):
    ...
    exe_path = fuzz_compile(dir_path=dir_path_git, exec_name="guided_statement_grammar_mutation_fuzzer")
    ...
    while time.time() < timeout_start + timeout:
        result, outcome, mutated_seed, coverage = mutation_based_fuzzer.run_statement_coverage(runner=runner_fuzzing_grammar)
