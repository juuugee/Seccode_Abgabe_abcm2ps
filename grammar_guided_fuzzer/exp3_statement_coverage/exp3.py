...
def run_grammar_guided_statement_coverage_fuzzer(
    ...
    exe_path = fuzz_compile(
        dir_path=dir_path_git, exec_name="guided_statement_grammar_mutation_fuzzer"
    )
    ...
    while time.time() < timeout_start + timeout:
        (
            ...
            mutated_seed,
            coverage,
        ) = mutation_based_fuzzer.run_statement_coverage(runner=runner_fuzzing_grammar)
