...
def run_mutation_coverage_fuzzer_branch_coverage(
    ...
    exe_path = fuzz_compile(
        dir_path=dir_path_git, exec_name="guided_branch_mutation_fuzzer"
    )
    ...
    while time.time() < timeout_start + timeout:
        (
            ...
            mutated_seed,
            coverage,
        ) = mutation_guided_fuzzer.run_line_coverage(runner=runner_fuzzing)
