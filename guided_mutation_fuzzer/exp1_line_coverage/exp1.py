...
def run_mutation_coverage_fuzzer_line_coverage(
    ...
    exe_path = fuzz_compile(
        dir_path=dir_path_git, exec_name="guided_line_mutation_fuzzer"
    )
    ...
    while time.time() < timeout_start + timeout:
        (
            ...
            mutated_seed,
            coverage,
        ) = mutation_guided_fuzzer.run_branch_coverage(runner=runner_fuzzing)
