...
class Logger():
    ...
    def get_information(self):
        ...
        self.passes_amount, self.crash_amount, self.unresolves_amount = self.runner.return_outcomes()
    ...
    def plot(self, path):
        ...
        infostring = "Exec: " + str(len(self.branch_coverage)) + "\n" + "Exec per sec: " + str(self.exec_per_sec) + "\n" + "Passes: " + str(self.passes_amount) + "\n" + "Fails: " + str(self.crash_amount) + "\n" + "Unresolved: " + str(self.unresolves_amount)
        ...
        plt.xlabel("Zeit in min")
        plt.axis([0, 30, 0,(max(self.crash_amount, self.unresolves_amount, self.passes_amount))])
        plt.plot(self.timestamp, self.crashes)
